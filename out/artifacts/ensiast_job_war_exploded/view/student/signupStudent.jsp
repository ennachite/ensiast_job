...
<section id="signupStudent" class="login_area">
    <div class="bg-red-50 h-screen flex flex-col justify-center items-center">
                ...
                <div class="pt-3 pb-0 ">
                    ...
                    <div class="mb-3 text-center">
                        <div class="mx-auto w-20 border rounded-full relative mb-4 shadow-inset">
                            <img id="image" class="object-cover w-full rounded-full"
                                 src="${pageContext.request.contextPath}/assets/img/student.svg" alt="student icon">
                        </div>
                    </div>
                    <!-- ============ End add picture ==============-->
                    ...
                    <div class="lg:flex mb-2 -mx-1">
                        ...
                        <div class="lg:w-1/2  mb-3 lg:mb-2 mx-1">
                            <div class="px-1">
                                ...
                                <input name="promo" type='number' min="1995"
                                       class="w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 hover:border-ensias-red"/>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Footer -->
        <p class="pt-2">You already have an account ? <a href="<c:url value="/login" />"
