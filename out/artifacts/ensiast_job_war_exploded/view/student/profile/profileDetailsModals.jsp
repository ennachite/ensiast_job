        ...
        <div class="mt-2 text-sm text-left">
            <form method="post" action="/profile/add-experience">
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="experience-title" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Title: Ex Software Engineer"/>
                </div>
                <div class="lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <select name="job-type"
                            class="w-full px-4 py-3 border bg-gray-300 rounded-lg hover:border-ensias-red">
                ...
                <div class=" lg:w-2/2 mt-5 mb-3 lg:mb-2 mx-1">
                    <input name="company-location" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Location: Ex Rabat, Morocco"/>
                </div>
                <div class=" lg:w-2/2 mt-5 lg:mb-2 mx-1 flex items-center">
                    <input name="still-working" value="now" type='checkbox'
                           class=" mr-3 px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"/>
                ...
                <div class=" lg:w-2/2 mt-5 lg:mb-2 mx-1">
                    ...
                    <input name="start-date" type='date'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Location: Ex Kenitra, Morocco"/>
                </div>
                <div class=" lg:w-2/2 mt-5 lg:mb-2 mx-1">
                ...
                <button type="submit"
                        class="w-full p-3 text-sm font-light text-white bg-theme-color rounded-lg shadow-md hover:bg-ensias-red mb-3">
                    Submit
                </button>
            </form>
        </div>
            ...
            <form method="post" action="/profile/add-education">
                ...
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="degree" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Degree: Ex Engineering"/>
                </div>
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="field-studies" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Field of study: Software Engineering"/>
                </div>
                <div class=" lg:w-2/2 mt-5 lg:mb-2 mx-1">
                    <label class="text-gray-600 font-light text-sm">Start date</label>
                    <input name="start-date" type='date'
    ...
    <div class="bg-gray-200  w-11/12 lg:w-full max-w-xl mt-140 px-3 rounded-xl shadow-xl text-gray-800">
        ...
        <div class="mt-2 text-sm text-left">
            <form method="post" action="/profile/add-certification">
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="certification-name" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Name: Ex Microsoft certified network associate security"/>
                </div>
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="issuing-organization" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Issuing organization: Ex Microsoft"/>
                </div>

                <div class=" lg:w-2/2 mt-5 lg:mb-2 mx-1 flex items-center">
                    <input name="dont-expire" value="dont expire" type='checkbox'
                           class=" mr-3 px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"/>
                ...
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="credential-id" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
                           placeholder="Credential ID"/>
                </div>
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="credential-url" type='url'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
    ...
    <div class="bg-gray-200  w-11/12 lg:w-full max-w-xl mt-140 px-3 rounded-xl shadow-xl text-gray-800">
        ...
        <div class="mt-2 text-sm text-left">
            <form method="post" action="/profile/add-language">
                <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                    <input name="language-name" type='text'
                           class="w-full px-4 py-3 border bg-gray-300 rounded-lg text-gray-800 hover:border-ensias-red"
