...
<div class="bg-white mt-8 mx-2 p-1 shadow-sm rounded-sm ">
    <div class="flex items-center justify-between mb-4 space-x-2 font-semibold text-zinc-900 text-2xl">
        ...
        <c:if test="${ sessionScope.role.equals('STUDENT') }">
            <a href="#"
               class="main-modal flex justify-between p-2 text-sm text-theme-color duration-150 bg-white border-1 border-ensias-red rounded-full hover:bg-red-900 hover:text-white"
               aria-label="Edit">
        ...
        <ul class="list-inside text-xl">
            <c:forEach items="${ requestScope.experiences }" var="experience">
                ...
                <li class="mb-3 border-b-2">
                    <div class="flex justify-between">
                        ...
                        <c:if test="${ sessionScope.role.equals('STUDENT') }">
                            <div class="flex items-center ">
                                <a href="${pageContext.request.contextPath}/profile/delete-experience?experienceIdDeleted=${ experience.experienceId }"
                                   class="main-modal p-2 text-theme-color duration-150 bg-white border-1 border-ensias-red rounded-full hover:bg-red-900 hover:text-white"
                                   aria-label="Edit">
                    ...
                    <div class="text-zinc-500 text-sm">${ experience.startDate } - ${ experience.endDate }, 2 months
                    </div>
            ...
            <c:forEach items="${ requestScope.educations }" var="education">
                ...
                <li class="mb-3 border-b-2 pb-3">
                    <div class="flex justify-between">
                        ...
                        <c:if test="${ sessionScope.role.equals('STUDENT') }">
                            <div class="flex items-center ">
                                <a href="${pageContext.request.contextPath}/profile/delete-education?educationIdDeleted=${ education.educationId }"
                                   class="main-modal p-2 text-theme-color duration-150 bg-white border-1 border-ensias-red rounded-full hover:bg-red-900 hover:text-white"
                                   aria-label="Delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                         viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex items-center my-4 space-x-2 font-semibold text-zinc-900 text-2xl">
            <span class="text-theme-color relative inline-block ">
                <svg class="h-8 w-8" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 19.95V22h12.998C26.55 22 27 21.551 27 20.993V8.007A.999.999 0 0 0 25.998 7H6.002C5.45 7 5 7.449 5 8.007v12.986A.999.999 0 0 0 6.002 22H8v-2.05a3.5 3.5 0 1 1 5 0Zm-4 .713V24.6l1.5-1.5 1.5 1.5v-3.937a3.486 3.486 0 0 1-1.5.337c-.537 0-1.045-.12-1.5-.337ZM8 23H6.005A2.002 2.002 0 0 1 4 21V8a2 2 0 0 1 2.005-2h19.99C27.103 6 28 6.895 28 8v13a2 2 0 0 1-2.005 2H13v4l-2.5-2.5L8 27v-4ZM7 11v1h18v-1H7Zm9 3v1h9v-1h-9Zm3 3v1h6v-1h-6Zm-8.5 3a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"
                          fill="#cc2426" fill-rule="evenodd" class="fill-929292"></path>
                </svg>
            </span>
            ...
            <c:forEach items="${ requestScope.certifications }" var="certification">
                ...
                <li class="mb-3 border-b-2 pb-3">
                    <div class="flex justify-between">
                        ...
                        <c:if test="${ sessionScope.role.equals('STUDENT') }">
                            <div class="flex items-center ">
                                <a href="${pageContext.request.contextPath}/profile/delete-certification?certificationIdDeleted=${ certification.certificationId }"
                                   class="main-modal p-2 text-theme-color duration-150 bg-white border-1 border-ensias-red rounded-full hover:bg-red-900 hover:text-white"
                                   aria-label="Delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                         viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="text-zinc-500 text-sm">Issued ${ certification.issueDate }
                        - ${ certification.expirationDate }</div>
                    <div class="text-zinc-500 text-sm">${ certification.credentialId }</div>
                    <div class="text-zinc-500 text-sm underline"><a href="${ certification.credentialUrl }"
                                                                    target="_blank"> See Credential URL</a></div>
                </li>
                <!-- ========== End Certification =========== -->
            </c:forEach>
        </ul>
            ...
            <span class="text-theme-color relative inline-block ">
                <svg class="h-7 w-7" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="m9.34 6.372.05.105 5.56 14.5a.755.755 0 0 1-.418.971.73.73 0 0 1-.91-.333l-.043-.092-1.433-3.737H5.06l-.094-.006-1.546 3.76a.73.73 0 0 1-.963.401.754.754 0 0 1-.427-.885l.033-.096 5.964-14.5a.73.73 0 0 1 1.314-.088Zm9.406-4.37a.75.75 0 0 1 .743.65l.007.1V7.5h1.75a.75.75 0 0 1 .743.649l.007.102a.75.75 0 0 1-.648.743L21.245 9l-1.75-.001v7.25a.75.75 0 0 1-.648.744l-.102.007a.75.75 0 0 1-.743-.648l-.007-.102V2.753a.75.75 0 0 1 .75-.75ZM8.81 8.748 5.65 16.286h6.11L8.81 8.747Zm1.937-6.744h5.498a.75.75 0 0 1 .743.648l.006.102v3.004c0 2.344-1.9 4.245-4.245 4.245a.75.75 0 0 1 0-1.5c1.46 0 2.654-1.14 2.74-2.578l.005-.167V3.503h-4.747a.75.75 0 0 1-.102-1.493l.102-.007h5.498-5.498Z"
                          fill="#cc2426" class="fill-212121"></path>
                </svg>
            </span>
            ...
            <c:forEach items="${ requestScope.languages }" var="language">
                ...
                <li class="mb-3 border-b-2 pb-3">
                    <div class="flex justify-between">
                        ...
                        <c:if test="${ sessionScope.role.equals('STUDENT') }">
                            <div class="flex items-center ">
                                <a href="${pageContext.request.contextPath}/profile/delete-language?languageIdDeleted=${ language.languageId }"
                                   class="main-modal p-2 text-theme-color duration-150 bg-white border-1 border-ensias-red rounded-full hover:bg-red-900 hover:text-white"
                                   aria-label="Delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                         viewBox="0 0 24 24" stroke="currentColor">
