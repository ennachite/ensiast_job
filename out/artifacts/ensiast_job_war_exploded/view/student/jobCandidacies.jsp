...
<!-- Title -->
<title> ${ sessionScope.student.firstName }'s Candidacies</title>
</head>
<body>
<%--Preloader--%>
    ...
    <div class="row justify-center">
        <div class="w-fully lg:w-1/2">
            <div class="section_title text-center pb-6">
                <h4 class="text-3xl md:text-5xl font-semibold mt-4">Be <span class="text-ensias-red">patient </span><br>
                    good things take time</h4>
            </div>
            <!-- section title -->
        </div>
    </div>
                                        ...
                                        <a href="<c:url value="/other-profile?companyId=${ candidacy.companyId }" />">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                                    <c:choose>
                                                        <c:when test="${ candidacy.companyPicture != null }">
                                                            <img class="object-cover w-full h-full rounded-full"
                                                                 src="http://localhost/${ candidacy.companyPicture }" alt=""
                                                                 loading="lazy"/>
                                                        </c:when>
                                                        <c:otherwise>
                                        ...
                                        <div class="bg-black bg-opacity-50 absolute inset-0 hidden justify-center items-center overlay">
                                            <div class="bg-gray-200  w-11/12 lg:w-full max-w-xl z-20 py-2 px-3 rounded-xl shadow-xl text-gray-800">
                                                <div class="flex justify-end items-center">
                                                    <svg class="h-7 w-7 cursor-pointer p-1 hover:bg-red-700 hover:text-white rounded-full text-red-900 close-modal "
                                                    ...
                                                    <div class="justify-left text-left">
                                                        <p class="pb-2 flex ">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 class="h-5 w-5 text-red-700 mr-1" viewBox="0 0 20 20"
                                                                 fill="currentColor">
                                                                <path fill-rule="evenodd"
