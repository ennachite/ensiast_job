                    ...
                    <form method="post" action="/add-admin">
                        ...
                        <div class="justify-left text-left pt-4">
                            <label class="block text-gray-600 mb-6 text-sm">
                                ...
                                <input name="admin-name" type="text"
                                       class="block w-full py-5 mt-1 h-8 text-sm pl-2 hover:border-ensias-red border-2 border-gray-400 rounded-md form-input"
                                       placeholder="Enter name admin"/>
                            </label>
                            <label class="block text-gray-600 mb-6 text-sm">
                                <span class="text-black">Gender</span>
                                <select name="admin-gender"
                                        class="block w-full mt-1 py-3 text-sm pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input">
                            ...
                            <label class="block text-gray-600 my-6 text-sm">
                                ...
                                <input name="admin-cin" type="text"
                                       class="block w-full py-5 mt-1 h-8 text-sm pl-2 hover:border-ensias-red border-2 border-gray-400 rounded-md form-input"
                                       placeholder="Enter CIN admin "/>
                            </label>
                            <label class="block text-gray-600 my-6 text-sm">
                            ...
                            <label class="block text-gray-600 my-6 text-sm">
                                ...
                                <input name="admin-birthdate" type="date"
                                       class="block w-full py-5 mt-1 h-8 text-sm pl-2 hover:border-ensias-red border-2 border-gray-400 rounded-md form-input"/>
                            </label>

                            <label class="block text-gray-600 my-6 text-sm">
                                <span class="text-black">Phone number</span>
                                <input name="admin-phone" type="tel"
                                       class="block w-full py-5 mt-1 h-8 text-sm pl-2 hover:border-ensias-red border-2 border-gray-400 rounded-md form-input"
                            ...
                            <label class="block text-gray-600 my-6 text-sm">
                                ...
                                <input name="email" type="email"
                                       class="block w-full mt-1 h-8 text-sm pl-2 py-5 hover:border-ensias-red border-2 border-gray-400 rounded-md form-input"
                            ...
                            <div class=" mt-6 pb-5 lg:mb-2 mx-1">
                                ...
                                <div class="relative w-full password_field">
                                    ...
                                    <input name="password"
                                           class="appearance-none w-full text-sm mt-1 py-2 px-2 border-2 border-gray-400 rounded-lg text-gray-700 hover:border-ensias-red js-password"
