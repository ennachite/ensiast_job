    ...
    <div class="row justify-center">
        <div class="w-fully lg:w-1/2">
            <div class="section_title text-center pt-5">
                <h4 class="main_title">Companies list</h4>
            </div>
            <!-- section title -->
        </div>
    </div>
                    ...
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <c:forEach items="${requestScope.companies}" var="company">
                            ...
                            <tr class="text-gray-700">
                                        ...
                                        <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                            <c:choose>
                                                <c:when test="${ company.pictureCompany != null }">
                                                    <img src="http://localhost/${ company.pictureCompany}" alt="Pdp"
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <p>${company.companyTif}</p>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <p>${company.companySizeWord}</p>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <p>${company.companyFix}</p>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    <a href="mailto:${company.emailCompany}">${company.emailCompany}</a>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                ...
                                <td class="px-4 py-3">
                                    <button class="px-2 py-2 text-sm font-medium leading-5 text-red-900 rounded-lg hover:border-red-700 hover:border-2 main-modal"
                                            aria-label="Delete">
