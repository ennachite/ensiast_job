                    ...
                    <div class="justify-left text-left">
                        ...
                        <form method="post" action="/add-offer">
                            ...
                            <label class="block  my-4">
                                ...
                                <input name="offer-salary" type="number"
                                       class="block w-full mt-1 h-8  pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input"
                                       placeholder="Ex: 10000"/>
                            </label>

                            <label class="block  my-4">
                                <span class="text-black">Location</span>
                                <input name="offer-location"
                                       class="block w-full mt-1 h-8 pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input"
                            ...
                            <label class="block mt-4 ">
                                ...
                                <select name="job-type"
                                        class="block w-full mt-1  pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input h-8">
                            ...
                            <label class="block mt-4 ">
                                ...
                                <textarea name="description"
                                          class="block w-full mt-1  focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input p-2 h-260 pb-5"
                                          rows="3" placeholder="Enter the description of the offer"></textarea>
                            </label>
