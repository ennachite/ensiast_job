            ...
            <div class="row items-center">
                <div class="w-full">
                    <nav class="flex items-center justify-between pt-2 navbar navbar-expand-lg">
                        ...
                        <div class="absolute left-0 z-20 hidden w-full px-5 py-1 duration-300 bg-white lg:w-auto collapse navbar-collapse lg:block top-full mt-full lg:static lg:bg-transparent shadow lg:shadow-none"
                             id="navbarOne">
                ...
                <div class="w-full lg:w-1/2">
                    <div class="header_hero_content pt-150 lg:pt-0">
                        <h2 class="hero_title text-2xl sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl font-extrabold">
                            Welcome to your professional community with <span
                                class="text-theme-color">ENSIAST JOB</span></h2>
                ...
                <div class="mt-3 flex justify-between space-x-3">
                    <a href="${pageContext.request.contextPath}/signup-student">
                        <button class="flex items-center justify-between px-10 py-4 font-medium leading-5 text-white transition-colors duration-150 bg-red-800 border border-transparent rounded-lg hover:bg-ensias-red">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-3" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
            ...
            <div class="w-full sm:w-10/12 md:w-6/12 lg:w-4/12">
                <div class="single_services text-center mt-8 mx-3">
                    ...
                    <div class="services_content mt-5">
                        <h3 class="services_title text-black font-semibold text-xl md:text-3xl">History &
                            Reputation</h3>
                        <p class="mt-4">Excellence in computer science training and research since its creation in 1992.
                            <br> National and international recognition as a leader in the field of ICT in Morocco in
                            the face of the challenges of globalization and technological change.</p>
                    </div>
                </div>
                <!-- single services -->
            </div>
            <div class="w-full sm:w-10/12 md:w-6/12 lg:w-4/12">
                <div class="single_services text-center mt-8 mx-3">
                    ...
                    <div class="services_content mt-5">
                        ...
                        <p class="mt-4">Seal of Quality recognized both by its domestic and foreign institutional
                            partners as well as by recruiting organizations. <br> The integration of the alumnis is 100%
                            in a very short period of no more than 5 months after graduation.</p>
                    </div>
                </div>
                <!-- single services -->
            </div>
            <div class="w-full sm:w-10/12 md:w-6/12 lg:w-4/12">
                <div class="single_services text-center mt-8 mx-3">
                    ...
                    <div class="services_content mt-5">
                        ...
                        <p class="mt-4">Adequacy of training to the needs of Moroccan companies and to government
                            guidelines and the needs of international cooperation for trade and mobility. <br> Practical
                            skills in various IT projects and experiences through various work placements.</p>
                    </div>
                </div>
                <!-- single services -->
            </div>
        ...
        <div class="row justify-center">
            <div class="w-fully lg:w-1/2">
                <div class="section_title text-center pb-6">
                    ...
                    <h5 class="sub_title mt-4">Innovation through its teaching methods and its evolving and diversified
                        training curriculum in 9 specialties</h5>
                </div>
                <!-- section title -->
            </div>
        </div>
                ...
                <div class="single_services text-center mt-8 mx-3">
                    ...
                    <div class="services_content mt-5 xl:mt-10">
                        <h3 class="services_title text-black font-semibold text-xl md:text-2xl lg:text-xl xl:text-3xl">
                            (GL)</h3>
                        <p class="mt-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam velit hic
                            distinctio perferendis cupiditate labore.</p>
                    </div>
                </div>
                <!-- single service -->
            </div>
                        ...
                        <div class="single_team mx-3">
                            ...
                            <div class="team_content py-5 px-8 relative">
                                <h4 class="team_name text-xl md:text-2xl"><a href="#"
                                                                             class="text-black group-hover:text-white">Soumya
                                    Kaddouri</a></h4>
                ...
                <div class="w-full lg:w-6/12">
                    <div class="single_team_item mx-auto">
                        <div class="single_team mx-3">
                            ...
                            <div class="team_content py-5 px-8 relative">
                                <h4 class="team_name text-xl md:text-2xl"><a href="#"
                                                                             class="text-black group-hover:text-white">Oussama
                                    Ennchite</a></h4>
                                <p class="mt-2 transition-all duration-300 group-hover:text-white">Software Engineer &
                                    CTO</p>
                            </div>
                        </div> <!-- single team -->
                    </div>
                                    ...
                                    <div class="mx-3">
                                        <div class="single_form mt-8">
                                            <input name="name" id="name" type="text" placeholder="Name"
                                                   class="w-full rounded-md py-4 px-4 border border-solid border-body-color">
                                        </div>
                                        <!-- single form -->
                                    </div>
                                </div>
