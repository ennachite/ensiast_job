                    ...
                    <form method="post">
                        ...
                        <div class=" mt-6 pb-5 lg:mb-2 mx-1">
                            ...
                            <div class="relative w-full password_field">
                                ...
                                <input name="current-password" class="appearance-none w-full mt-1 py-2 px-2 border-2 border-gray-400 rounded-lg text-gray-700 hover:border-ensias-red js-password" id="password" type="password" autocomplete="off" />
                            </div>
                        ...
                        <div class=" mt-4 pb-5 lg:mb-2 mx-1">
                            ...
                            <div class="relative w-full password_field">
                                ...
                                <input name="new-password" class="appearance-none w-full mt-1 py-2 px-2 border-2 border-gray-400 rounded-lg text-gray-700 hover:border-ensias-red js-password" id="password1" type="password" autocomplete="off" />
                            </div>
