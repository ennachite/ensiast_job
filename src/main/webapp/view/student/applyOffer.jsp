        ...
        <div class="w-full sm:w-10/12 md:w-6/12 lg:w-12/12 h-12/12">
            ...
            <div class="py-6 bg-gray-50 border-b-2 border-b-gray-200 shadow-md focus:outline-none">
                <div class="flex justify-between m-2 mr-0 pl-3">
                    <div class="flex justify-items-center">
                        <c:choose>
                            <c:when test="${ requestScope.offer.companyPicture != null }">
                                <img src="http://localhost/${ requestScope.offer.companyPicture }" alt="company-logo"
                                     class="border-gray-200 border-2 rounded-lg mr-4 text-center" width="130px"
                                     height="100px">
                            </c:when>
                            <c:otherwise>
                                <img src="${pageContext.request.contextPath}/assets/img/company.png" alt="company-logo"
                                     class="border-gray-200 border-2 rounded-lg mr-4 text-center" width="130px"
                                     height="100px">
                            </c:otherwise>
                        </c:choose>
                    ...
                    <div class="m-4">
                        <button type="button"
                                class="px-2 py-2 text-sm font-medium leading-5 bg-red-50 text-ensias-red rounded-lg hover:bg-ensias-red hover:text-white focus:outline-none">
            ...
            <div class="p-6 bg-gray-50 mt-8 shadow-md focus:outline-none">
                ...
                <form method="post" action="/apply-offer?offerId=${ requestScope.offer.offerId }"
                      enctype="multipart/form-data">
                    <div class=" lg:w-2/2  mb-3 mt-5 lg:mb-2 mx-1">
                        <input name="github-username" type='text'
                               class="w-full mb-2 px-4 py-3 border rounded-lg text-gray-700 hover:border-ensias-red"
                    ...
                    <div class=" lg:w-2/2  mb-3 lg:mb-2 mx-1">
                        <label class="w-64 flex flex-col items-center mb-5 px-4 py-1 bg-white rounded-lg border hover:border-ensias-red">
                            ...
                            <input name="cv-file" type='file' class="hidden"
                    ...
                    <div class=" lg:w-2/2  mt-3 lg:mb-2 mx-1">
                        <textarea name="motivation"
                                  class=" w-full mb-2 px-4 py-3 border rounded-lg text-gray-700 hover:border-ensias-red h-260"
                                  rows="3" placeholder="Your motivation about the offer"></textarea>
                    </div>
                    <div class="text-center">
                        <button type="submit"
                                class="w-full py-3 px-6 my-4 text-sm font-bold border-2 border-ensias-red leading-5 bg-ensias-red text-white rounded-lg hover:bg-white hover:text-ensias-red">
                            Apply Now
                        </button>
                    </div>
                </form>
