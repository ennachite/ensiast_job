                                ...
                                <div class="flex justify-between m-2 mr-0 pl-3">
                                    <div class="flex justify-items-center">
                                        <c:choose>
                                            <c:when test="${ offer.companyPicture != null }">
                                                <img src="http://localhost/${ offer.companyPicture }" alt="company-logo"
                                        ...
                                        <div class="grid grid-cols-1 justify-center">
                                            <a href="<c:url value="/apply-offer?offerId=${ offer.offerId }" />"
                                               class="pb-0">
                                                <h2 class="text-red-900 font-semibold pt-6 pb-0 ">${ offer.offerName }</h2>
                                            </a>
                                            <a href="<c:url value="/other-profile?companyId=${ offer.companyId }" />"
                                               class="pb-2">
                                    ...
                                    <div class="">
                                        <div class="flex m-4">
                                            ...
                                            <button type="button"
                                                    class="px-4 py-2 mx-2 mt-4 text-sm font-medium leading-5 bg-red-50 text-ensias-red rounded-lg hover:bg-ensias-red hover:text-white focus:outline-none">
                                            ...
                                            <div class="text-center">
                                                <button type="button"
                                                        class="flex py-3 px-6 mx-4 mt-4 text-sm font-bold border-2 border-ensias-red leading-5 bg-ensias-red text-white rounded-lg hover:bg-white hover:text-ensias-red focus:outline-none">
                                                    <a href="<c:url value="/apply-offer?offerId=${ offer.offerId }" />"
                                                       class="pr-1">Apply Now</a>
                                                </button>
                                                <!-- </a> -->
                                            </div>
                                        </div>
