        ...
        <div class="row justify-center">
            <c:forEach items="${ requestScope.offers }" var="offer">
                ...
                <div class="w-full sm:w-10/12 md:w-6/12 lg:w-3/12">
                    <div class="${offer.approvedOffer ? '' : 'bg-gray-50'} grid_offer text-center mt-8 mx-3">
                        <p class="text-left pl-1 font-thin">${ offer.postTime }</p>

                        <div class="pt-3 relative inline-block">
                            <img src="https://img.icons8.com/ios/50/000000/find-matching-job.png" class="h-10 w-10"
                                 alt="job offer"/>
                        </div>
                        <div class="mt-3 xl:mt-10">
                            <h4 class="text-black font-semibold text-sm md:text-2xl lg:text-xl xl:text-3xl pb-3 capitalize">
                                    ${ offer.offerName }
                            </h4>
                            <p class="text-left flex justify-left border-r-4 border-white">
                                <span>${offer.approvedOffer ? "" : "(Offer not approved yet)"}</span>
                            </p>
                            <p class="text-left flex justify-left border-r-4 border-white">
                        ...
                        <div class="flex flex-row items-center mt-3 border-t border-gray-300 justify-center">
                            <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-ensias-red hover:text-white"
                               href="<c:url value="/offer-details?offerId=${ offer.offerId }" />">
                            ...
                            <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-ensias-red hover:text-white"
                               href="<c:url value="/offer-candidacies?offerId=${ offer.offerId }" />">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 stroke-current" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-ensias-red hover:text-white"
                               href="<c:url value="/modify-job-offer?offerId=${ offer.offerId }" />">
                            ...
                            <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-ensias-red hover:text-white main-modal"
                               href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                     stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
