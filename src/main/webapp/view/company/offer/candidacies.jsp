                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <c:forEach items="${ requestScope.candidacies }" var="candidacy">
                                ...
                                <tr class="text-gray-700">
                                        ...
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full"
                                                     src="http://localhost/${ candidacy.studentPicture }" alt=""
                                                     loading="lazy"/>
                                            ...
                                            <div>
                                                <a class="font-semibold"
                                                   href="<c:url value="/other-profile?studentId=${candidacy.studentId}" />">${ candidacy.studentName }</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        <a href="<c:url value="https://github.com/${ candidacy.githubUsername }" />"
                                           target="_blank">${ candidacy.githubUsername }</a>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        ...
                                        <div class="bg-black bg-opacity-50 absolute inset-0 hidden justify-center items-center overlay">
                                            <div class="bg-gray-200  w-11/12 lg:w-full max-w-xl z-20 py-2 px-3 rounded-xl shadow-xl text-gray-800">
                                                <div class="flex justify-between items-center">
                                                    <h4 class="text-lg font-bold text-red-900 pl-1">About candidate
                                                        motivation</h4>
                                    ...
                                    <td class="px-4 py-3 text-sm"><a href="http://localhost/${ candidacy.studentCV }"
                                                                     class="underline"
                                                                     target="_blank">${candidacy.studentName}_CV</a>
                                    </td>
                                            ...
                                            <c:otherwise>
                                                <div class="flex justify-center text-sm">
                                                    <a href="<c:url value="/modify-candidacy-status?candidacyId=${ candidacy.candidacyId }&candidacyStatus=1" />">
                                                        <button class="flex items-center justify-between mr-4 px-2 py-2 text-sm font-medium leading-5 text-gray-500 rounded-lg hover:border-green-700 hover:border-2 "
                                                                aria-label="Edit">
                                                    ...
                                                    <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-gray-500 rounded-lg hover:border-red-700 hover:border-2 main-modal"
                                                            aria-label="Delete">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                             fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <div class="bg-black bg-opacity-70 absolute inset-0 hidden justify-center items-center overlay">
                                                        <div class="bg-gray-200 max-w-sm max-h-lg py-2 px-3 rounded-xl shadow-xl text-gray-800">
                                                            ...
                                                            <div class="mt-2 text-sm">
                                                                <p>
                                                                    Do you really want to decline this candidate? This
                                                                    process
                                                                    cannot be undone
                                                                </p>
                                                            </div>
