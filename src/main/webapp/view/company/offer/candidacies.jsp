                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <a href="https://github.com/soumyaKaddouri">SoumyaKaddouri</a>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    ...
                                    <div class="bg-black bg-opacity-50 absolute inset-0 hidden justify-center items-center overlay">
                                        <div class="bg-gray-200  w-11/12 lg:w-full max-w-xl z-20 py-2 px-3 rounded-xl shadow-xl text-gray-800">
                                            ...
                                            <div class="mt-2 text-sm text-left">
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio voluptatem eius
                                                    magnam dolore rerum praesentium voluptate dolores possimus neque eum dignissimos, quis
                                                    itaque est molestias qui minus hic accusantium voluptates? Lorem ipsum dolor sit amet
                                                    consectetur adipisicing elit. Dolore eveniet dignissimos optio ipsam asperiores eaque
                                                    magni nobis magnam consequatur, expedita, voluptas aut, cumque repellat? Quam amet
                                                    necessitatibus molestias doloremque cupiditate! Lorem ipsum, dolor sit amet consectetur
                                                    adipisicing elit. Tempore, reiciendis aliquid, ducimus ad totam odio itaque facilis,
                                                    fugiat cum reprehenderit repellat quas ipsa error. Eligendi distinctio reprehenderit
                                                    quae praesentium assumenda. Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                    Fugit modi vel corporis tempora nostrum vero. Cum ullam doloribus laborum voluptates,
                                                    minima, recusandae saepe molestias tempore alias inventore quod fugit deserunt!
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td class="px-4 py-3 text-sm"><a href="#" class="underline">HansBurger_CV.pdf</a></td>
