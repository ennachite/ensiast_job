                ...
                <div class="grid_offer text-center mt-8 mx-3">
                    ...
                    <div class="justify-left text-left">
                        <label class="block text-sm">
                            ...
                            <input class="block w-full mt-1 h-8 text-sm pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input" placeholder="Platform Engineer"/>
                        </label>

                        <label class="block text-sm my-4">
                            <span class="text-black">Salary/Month (MAD)</span>
                            <input class="block w-full mt-1 h-8 text-sm pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input" placeholder="Ex: 10000"
                            />
                        </label>

                        <label class="block text-sm my-4">
                            <span class="text-black">Location</span>
                            <input class="block w-full mt-1 h-8 text-sm pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input" placeholder="Country,City"/>
                        </label>

                        <label class="block text-sm my-4">
                            <span class="text-black">Domain</span>
                            <input class="block w-full mt-1 h-8 text-sm pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input" placeholder="Web development, Mobile development..."/>
                        </label>

                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700"> Types of employees </span>
                            <select class="block w-full mt-1 text-sm pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input h-8">
                        ...
                        <label class="block mt-4 text-sm">
                            <span class="text-gray-70"> Types of internships </span>
                            <select class="block w-full mt-1 text-sm pl-2 focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input h-8" >
                                <option>Observation internship</option>
                                <option>Application internship</option>
                                <option>Internship of the end of school program</option>
                            </select>
                        </label>

                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700">Description</span>
                            <textarea class="block w-full mt-1 text-sm focus:border-ensias-red focus:border-2 border-2 border-gray-400 rounded-md form-input p-2 h-260 pb-5" rows="3" placeholder="Enter the description of the offer" ></textarea>
                        </label>
