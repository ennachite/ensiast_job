        ...
        <div class="w-full md:w-3/12 md:mx-2">
            ...
            <div class="single_team mx-3">
                <div class="team_image overflow-hidden">
                    <img src="${pageContext.request.contextPath}/assets/img/company.png" alt="company-logo" class="h-auto w-full mx-auto">
                </div>
                <div class="m-2 p-2">
                    <p class="text-lg text-zinc-500 hover:text-zinc-600">${ sessionScope.company.description }</p>
        ...
        <div class="w-full md:w-9/12 mx-2 my-4">
            ...
            <div class="bg-white mt-8 mx-2 p-1 shadow-sm rounded-sm ">
                <div class="flex items-center justify-between my-4 space-x-2 font-semibold text-zinc-900 text-2xl">
                    ...
                    <a href="modifyCompanyProfile.html" class="flex items-center justify-between px-3 py-3 text-sm font-medium leading-5 text-theme-color duration-150 bg-white border-1 border-ensias-red rounded-full hover:bg-red-900 hover:text-white" aria-label="Edit">
                ...
                <div class="text-zinc-700">
                    <div class="grid md:grid-cols-2 text-lg">
                        <div class="grid grid-cols-2">
                            ...
                            <div class="px-4 py-2 capitalize">${ sessionScope.company.companyName }</div>
                        </div>
                        <div class="grid grid-cols-2">
                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <div class="px-4 py-2">${ sessionScope.company.companySizeWord }</div>
                        </div>
                        <div class="grid grid-cols-2">
                            <div class="px-4 py-2 font-semibold">Phone number</div>
                            <div class="px-4 py-2">${ sessionScope.company.companyFix }</div>
                        </div>
                        <div class="grid grid-cols-2">
                        ...
                        <div class="grid grid-cols-2 ">
                            ...
                            <div class="px-4 py-2">${ sessionScope.company.companyTif }</div>
                        </div>
                        <div class="grid grid-cols-2 ">
                            <div class="px-4 py-2 font-semibold">Founded</div>
                            <div class="px-4 py-2">${ sessionScope.company.founded }</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-2">
                    ...
                    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs companyProfile-grid ">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-700 ">
                                ${ sessionScope.company.companySize } +
                            </p>
                        </div>
                    </div>
                    <!-- Card -->
