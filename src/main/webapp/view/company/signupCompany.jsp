...
<section id="signupCompany" class="login_area">
    <div class="bg-red-50 h-screen flex flex-col justify-center items-center">
            ...
            <form method="post" action="/signup-company">
                <div class="pt-3 pb-1 ">
                    ...
                    <div class="text-center mx-auto w-20 border rounded-full relative mb-5 shadow-inset">
                        <img id="image" class="object-cover w-full rounded-full" src="assets/img/company.svg" alt="company">
                    </div>
                    <!-- ============ End add picture ==============-->
                    ...
                    <div class="lg:flex mb-3 -mx-1">
                        <div class="lg:w-1/2 mb-3 lg:mb-2 mx-1">
                            <div class="px-1">
                                ...
                                <input name="company-name" type='text' class="w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 hover:border-ensias-red" placeholder="Enter company name" />
                            </div>
                        </div>
                        <div class="lg:w-1/2  mb-3 lg:mb-2 mx-1">
                            <div class="px-1">
                                <label class="text-gray-600 font-light">Company CEO</label>
                                <input name="ceo-name" type='text' class="w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 hover:border-ensias-red" placeholder="Enter CEO name" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:flex mb-3 -mx-1">
                        <div class="lg:w-1/2 mb-3 lg:mb-2 mx-1">
                            <div class="px-1">
                                ...
                                <input name="company-tif" type='text' class="w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 hover:border-ensias-red" placeholder="Enter TIN" />
                            </div>
                        </div>
                        <div class="lg:w-1/2  mb-3 lg:mb-2 mx-1">
                            <div class="px-1">
                    ...
                    <div class="lg:flex mb-3 -mx-1">
                        <div class="lg:w-1/2 mb-3 lg:mb-2 mx-1">
                            <div class="px-1">
                                ...
                                <input name="company-size" type='number' class="w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 hover:border-ensias-red" placeholder="Enter number of employees" />
                            </div>
                        </div>
                        <div class="lg:w-1/2  mb-3 lg:mb-2 mx-1">
                            <div class="px-1">
                                <label class="text-gray-600 font-light">Founded</label>
                                <input name="founded" type='number' class="w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 hover:border-ensias-red" placeholder="Enter date of foundation" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" mb-3 -mx-1 ">
                        <div class="lg:w-2/2  mb-3 lg:mb-2 mx-1">
                            ...
                            <div class="relative w-full password_field">
                                ...
                                <input name="password" class="appearance-none w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 hover:border-ensias-red js-password" id="password" type="password" autocomplete="off" placeholder="Enter your password" />
                            </div>
        ...
        <!-- Footer -->
        <p class="pt-4 pb-1">You already have an account ? <a href="<c:url value="/login" />" class="text-the font-medium hover:text-white hover:bg-ensias-red">Login</a></p>
    </div>
</section>
