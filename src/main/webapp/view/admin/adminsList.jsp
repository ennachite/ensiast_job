            ...
            <div class="row justify-center">
                <div class="w-fully lg:w-1/2">
                    <div class="section_title text-center pt-5">
                        <h4 class="main_title">Administrators list</h4>
                    </div>
                    <!-- section title -->
                </div>
            </div>
                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tr class="text-gray-700">
                                    <td class="px-4 py-3 text-sm">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                                <c:choose>
                                                    <c:when test="${ admin.pictureAdmin != null }">
                                                        <img src="http://localhost/${ admin.pictureAdmin }" alt="Pdp" class="object-cover w-full h-full rounded-full" loading="lazy" />
                                                    </c:when>
                                                    <c:otherwise>
                                                        <img src="assets/img/person.jpg" alt="Pdp" class="object-cover w-full h-full rounded-full">
                                                    </c:otherwise>
                                                </c:choose>
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <p>${admin.adminBirthdate}</p>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        <p>${admin.adminPhone}</p>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                                        <a href="mailto:${admin.emailAdmin}">${admin.emailAdmin}</a>
                                    </td>
                                    <td class="px-4 py-3">
                                        <button
