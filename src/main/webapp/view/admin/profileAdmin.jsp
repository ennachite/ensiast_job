...
<jsp:include page="${pageContext.request.contextPath}/view/admin/sidebareAdmin.jsp" />
        ...
        <div
            ...
            <div class="relative h-40">
                <img class="absolute h-full w-full object-cover"  src="${pageContext.request.contextPath}/assets/img/bg-admin.jpg" alt="bg admin image" />
            ...
            <div class="relative shadow mx-auto h-24 w-24 -my-12 border-white rounded-full overflow-hidden border-4">
                <c:choose>
                    <c:when test="${ sessionScope.member.picture != null }">
                        <img src="http://localhost/${ sessionScope.member.picture }" alt="Pdp" class="object-cover w-full h-full" />
                    </c:when>
                    <c:otherwise>
            ...
            <div class="bg-white mt-4 mx-2 p-1 shadow-sm rounded-sm border-t ">
                ...
                <div class="text-zinc-700">
                    <div class="grid md:grid-cols-2 text-lg">
                        ...
                        <div class="grid grid-cols-2 px-4 py-2 "><a href="mailto:${ sessionScope.member.email}">${ sessionScope.member.email}</a>
                        </div>
                    </div>
                </div>
            </div>
